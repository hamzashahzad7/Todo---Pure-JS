!(function (t) {
            ...
            ? ((p = r(function (t, r, e, i) {
                ...
                if (S(r)) {
                  if (
                    ...
                    return bt in r ? Ft(p, r) : Tt.call(p, r);
                  (o = r), (v = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === i) {
  ...
  function (t, n, r) {
    ...
    function z(t, n, r, e, i, o) {
      ...
      for (var c = t[j]._b, f = u + t[N], a = e(+i), s = 0; s < n; s++)
        c[f + s] = a[o ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
    ...
    t.exports = function (t, n, r, p, d, g, y) {
      ...
      if (
        (A &&
          ...
          x.next &&
          (a(x, w, !0), e || "function" == typeof x[l] || u(x, l, v)),
        _ &&
          M &&
          "values" !== M.name &&
          ((E = !0),
  ...
  function (t, n, r) {
    ...
    var e = { searchText: "", hideCompleted: !1 };
    (n.getFilters = function () {
      return e;
    }),
      (n.setFilters = function (t) {
        "string" == typeof t.searchText && (e.searchText = t.searchText),
          "boolean" == typeof t.hideCompleted &&
            (e.hideCompleted = t.hideCompleted);
      });
  },
  function (t, n, r) {
    "use strict";
    ...
    c(),
      ...
      (n.createTodo = function (t) {
        u.push({ id: (0, o.default)(), text: t, completed: !1 }), f();
      }),
      (n.removeTodo = function (t) {
        var n = u.findIndex(function (n) {
          return n.id === t;
        });
        n > -1 && (u.splice(n, 1), f());
      }),
      (n.toggleTodo = function (t) {
        var n = u.find(function (n) {
          return n.id === t;
        });
        n && ((n.completed = !n.completed), f());
      });
  },
  function (t, n) {
    t.exports =
  ...
  function (t, n, r) {
    ...
    var e,
      ...
      m = (t.exports = r(53)("WeakMap", g, y, f, !0, !0));
    s(function () {
      return 7 != new m().set((Object.freeze || Object)(d), 7).get(d);
    }) &&
      (c((e = f.getConstructor(g, "WeakMap")).prototype, y),
      (u.NEED = !0),
  ...
  function (t, n, r) {
    "use strict";
    Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.generateSummaryDOM = n.renderTodos = n.generateTodoDOM = void 0);
    var e = r(91),
      i = r(90),
      o = function () {
        var t = document.querySelector("#todos"),
          n = (0, i.getFilters)(),
          r = (0, e.getTodos)().filter(function (t) {
            var r = t.text.toLowerCase().includes(n.searchText.toLowerCase()),
              e = !n.hideCompleted || !t.completed;
            return r && e;
          }),
          o = r.filter(function (t) {
            return !t.completed;
          });
        if (((t.innerHTML = ""), t.appendChild(c(o)), r.length > 0))
          r.forEach(function (n) {
            t.appendChild(u(n));
          });
        else {
          var f = document.createElement("p");
          f.classList.add("empty-message"),
            (f.textContent = "There are no to-dos to show"),
            t.appendChild(f);
        }
      },
      u = function (t) {
        ...
        return (
          ...
          i.addEventListener("change", function () {
            (0, e.toggleTodo)(t.id), o();
          }),
          (u.textContent = t.text),
          r.appendChild(u),
          n.classList.add("list-item"),
          r.classList.add("list-item__container"),
          n.appendChild(r),
          (c.textContent = "remove"),
          c.classList.add("button", "button--text"),
          n.appendChild(c),
          c.addEventListener("click", function () {
            (0, e.removeTodo)(t.id), o();
          }),
          n
        );
      },
      c = function (t) {
        var n = document.createElement("h2"),
          r = 1 === t.length ? "" : "s";
        return (
          n.classList.add("list-title"),
          (n.textContent = "You have " + t.length + " todo" + r + " left"),
          n
        );
      };
    (n.generateTodoDOM = u), (n.renderTodos = o), (n.generateSummaryDOM = c);
  },
  function (t, n, r) {
    "use strict";
    var e = r(130),
    ...
    (0, e.renderTodos)(),
      document
        ...
        .addEventListener("input", function (t) {
          (0, i.setFilters)({ searchText: t.target.value }),
            (0, e.renderTodos)();
        }),
      document
        .querySelector("#new-todo")
        .addEventListener("submit", function (t) {
          var n = t.target.elements.text.value.trim();
          t.preventDefault(),
            n.length > 0 &&
              ((0, o.createTodo)(n),
              (0, e.renderTodos)(),
      ...
      document
        ...
        .addEventListener("change", function (t) {
          (0, i.setFilters)({ hideCompleted: t.target.checked }),
            (0, e.renderTodos)();
        }),
      window.addEventListener("storage", function (t) {
        "todos" === t.key && ((0, o.loadTodos)(), (0, e.renderTodos)());
      });
  },
  function (t, n) {
    t.exports = function (t, n) {
  ...
  function (t, n, r) {
    r(133), (t.exports = r(26).RegExp.escape);
  },
  function (t, n, r) {
    (function (n) {
      !(function (n) {
        ...
        if (s) a && (t.exports = s);
          ...
          (s = n.regeneratorRuntime = a ? t.exports : {}).wrap = x;
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.P + e.R, "Set", { toJSON: r(94)("Set") });
  },
  function (t, n, r) {
    var e = r(0);
    e(e.P + e.R, "Map", { toJSON: r(94)("Map") });
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.P, "Array", { copyWithin: r(109) }), r(29)("copyWithin");
  },
  function (t, n, r) {
    "use strict";
    var e = r(0),
  ...
  function (t, n, r) {
    var e = r(0);
    e(e.S + e.F * !r(8), "Object", { defineProperties: r(122) });
  },
  function (t, n, r) {
    var e = r(0);
  ...
  function (t, n, r) {
    ...
    var e = r(2),
      ...
      X = function (t, n) {
        if (((t = x(t)), (n = S(n, !0)), t !== G || !i(D, n) || i(W, n))) {
          var r = F(t, n);
          return (
            !r || !i(D, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r
          );
        }
      },
      $ = function (t) {
        for (var n, r = T(x(t)), e = [], o = 0; r.length > o; )
          i(D, (n = r[o++])) || n == L || n == f || e.push(n);
        return e;
      },
      Z = function (t) {
        for (
          var n, r = t === G, e = T(r ? W : x(t)), o = [], u = 0;
          e.length > u;
    ...
    U ||
      ...
      (r(47).f = H),
      (r(60).f = Z),
      o && !r(39) && c(G, "propertyIsEnumerable", H, !0),
      (p.f = function (t) {
        return Y(v(t));
      })),
    ...
    u(u.S + u.F * !U, "Symbol", {
      ...
      j.prototype[k] || r(13)(j.prototype, k, j.prototype.valueOf),
      l(j, "Symbol"),
      l(Math, "Math", !0),
      l(e.JSON, "JSON", !0);
  },
  ...
  function (t, n, r) {
    "use strict";
    (function (t) {
      if ((r(332), r(135), r(134), t._babelPolyfill))
